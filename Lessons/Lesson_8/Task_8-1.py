...
import PhonebookController, PhonebookModel, PhonebookView 

model = PhonebookModel.PhonebookModel()
controller = PhonebookController.PhonebookController(model)
view = PhonebookView.PhonebookView(model, controller)
controller.run_phone_book()