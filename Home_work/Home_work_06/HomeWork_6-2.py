...
def entry(lst : list, min_border, max_border) -> tuple:
    border = [item for item in range(min_border, max_border + 1)]
    return [(idx, el) for idx, el in enumerate(lst) if el in border]

lst1 = [-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7]
print(entry(lst1, 2, 10))
print(entry(lst1, 2, 9))
print(entry(lst1, 0, 6))