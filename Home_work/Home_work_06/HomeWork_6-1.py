...
def аrithmetic_progression(start : int, step : int, ndigits : int) -> list:
    return [start + el * step for el in range(ndigits)]

start, step, ndigits = [int(input()) for el in range(3)]
print(аrithmetic_progression(start, step, ndigits))